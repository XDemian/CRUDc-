...
namespace DemianCRUD 
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<DemianCRUDContext>(options =>
            options.UseSqlServer("Server=localhost;Database=DemianCRUDBase;Trusted_Connection=True;MultipleActiveResultSets=true"));
